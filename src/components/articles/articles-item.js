  ...
  return (
    <div className={articles.articles__item}>
      <div className={articles.articles__header}>
        <h2 className={articles.articles__title} onClick={articleClick} aria-hidden="true">
          {title}
        </h2>
        <div className={articles.articles__like}>
          <svg
            className={`${articles['articles__like-img']} ${favorited && `${articles['articles__like-img--active']}`}`}
...
export const ArticlesItem = connect(mapStateToProps, actions)(ArticlesItemMain)
