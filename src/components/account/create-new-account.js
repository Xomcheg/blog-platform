...
function CreateNewAccount({
  ...
  const [password, setPassword] = useState()
  const { accountCheckInformation, userNameError, emailError, statusSubmitForm, loginStatus } = state
  ...
  useEffect(() => {
    if (statusSubmitForm) {
      reset()
      // console.log('statusSubmitForm', statusSubmitForm)
      setStatusSubmitForm()
    }
  }, [statusSubmitForm])
  useEffect(() => {
  ...
  // useEffect(() => {
  //   console.log('isValid', isValid, 'accountCheckInformation', accountCheckInformation)
  // }, [isValid, accountCheckInformation])
          ...
          <div className={account['account__check-information']}>
            <div className={account.account__box}>
              <input
                ...
                // {...register('checkAccountInformation'), }
              />
